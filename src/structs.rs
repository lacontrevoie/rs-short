...
impl NewLink {
    ...
    // ---------------------------------------------------------------
    pub fn validate(&self, l: &ValidLanguages, req: &HttpRequest,  captcha_key: (NaiveDateTime, String)) -> Result<(), TplNotification> {
